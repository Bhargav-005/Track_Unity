        ...
        <div className="glass-dark border border-white/10 rounded-[32px] p-10 md:p-12 shadow-2xl">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0a0f1c] text-gray-500">Or continue with</span>
            </div>
          </div>

          <div className="space-y-4">
            <button className="w-full glass flex items-center justify-center gap-3 py-4 rounded-2xl hover:bg-white/10 transition-all text-sm font-medium">
          ...
          <p className="mt-10 text-center text-gray-500 text-sm">
            Don't have an account? <Link to="/onboarding" className="text-blue-500 hover:underline">Sign up for free</Link>
          </p>
        </div>
      </motion.div>
    </div>
